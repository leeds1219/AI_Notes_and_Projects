...
\icmltitle{COSE474-2021F: Final Project Proposal \\
           ``Lipreading for Visual Speech Recognition''}
...
\icmlkeywords{Machine Learning, Lipreading, ICML}
...
\textcolor{blue}{Recognizing speech from the movenment of a human mouth ... } \\
\section{Problem definition \& chanllenges}
\textcolor{blue}{In order to process the data, we first need to extract the visual and temporal features
from the video dataset. Followed by processing the features into speech(characters, words, phrases, etc).} \\
\textcolor{blue}{Describe the challenges (explain why your problem is not trivial.)} \\

\section{Related Works }
\textcolor{blue}{LipNet ... }
.
\section{Datasets}
\textcolor{blue}{Lipreading datasets and why we choosed it limits ...}
\section{State-of-the-art methods and baselines}
\textcolor{blue}{Current trends and the best models are ... }

\section{Schedules}
\textcolor{blue}{2023/10/21 set the schedule and the goal of the Project
2023/10/31 
2023/11/12
2023/11/19
2023/11/26
2023/12/03 finish the report and ...  }
